    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-black/95 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <div className="w-9 h-9 bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl flex items-center justify-center text-2xl font-black">
              E
            </div>
          ...
          <div className="hidden md:flex items-center gap-10 text-sm font-medium">
            ...
            <a href="#how" className="hover:text-orange-400 transition-colors">
              Как работает
            </a>
            <a href="#cases" className="hover:text-orange-400 transition-colors">
              Кейсы
            </a>
      ...
      <section className="min-h-screen flex items-center relative pt-24">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          ...
          >
            Генерирует мощные карточки товаров, анализирует конкурентов
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center mb-20">
            <motion.button
              ...
              onClick={() =>
                alert('Генератор пока в разработке. Скоро будет доступен!')
              }
            ...
            <motion.button
              ...
              onClick={() =>
                alert('Демо видео скоро будет добавлено')
              }
            ...
            {[
              {
                ...
                desc: 'Загрузи фото или ссылку — получи SEO-заголовки, описание, инфографику и видео-обложку за 30 секунд.',
              },
              {
                icon: '📊',
                title: 'Аналитика конкурентов',
                desc: 'Автоматически отслеживает цены, остатки и позиции конкурентов. Даёт рекомендации по ценам и акциям.',
              },
              {
                icon: '💬',
                title: 'Автоответы на отзывы',
                desc: 'Отвечает покупателям 24/7, превращает негатив в продажи и защищает репутацию магазина.',
              },
            ].map((item, index) => (
              <motion.div
                key={index}
            ...
            {[
              {
                ...
                desc: 'CTR вырос на 87%, продажи — на 62% за первый месяц.',
              },
              {
                percent: '↓ 71%',
                title: 'Электроника',
                desc: 'Автоответы снизили негативные отзывы на 71% и увеличили повторные покупки.',
              },
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section id="pricing" className="py-24 bg-black">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <motion.div
              variants={cardVariants}
              className="bg-zinc-900 p-10 rounded-3xl border border-zinc-700"
            >
              ...
              <button className="w-full py-4 border border-white/30 rounded-2xl">
                Начать бесплатно
              </button>
            </motion.div>
            ...
            >
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-orange-700 text-white text-xs px-5 py-1 rounded-full">
                РЕКОМЕНДУЕМ
              </div>
              <h3 className="text-2xl font-bold mb-2">Pro</h3>
              <p className="text-5xl font-black mb-8">
                29 000 ₽<span className="text-base">/мес</span>
              </p>
              ...
              <button className="w-full py-4 bg-white text-black rounded-2xl font-semibold">
                Выбрать Pro
              </button>
            </motion.div>
